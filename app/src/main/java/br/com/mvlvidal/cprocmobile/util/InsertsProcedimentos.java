...
public class InsertsProcedimentos {
    ...
    public List<String> inserir(){
        ...
        List<String> inserts = new ArrayList<>();
         ...
         inserts.add("insert into procedimento (descricao,codigo,ch,co,porteMedico,porteAnestesico,qtdFilme,qtdAuxilio,tipo,tabela,percPorte) values ('Exame AMB',1004012,100.0,0,null,0,1.5,0,'sadt','amb92',1.0);");
         ...
         inserts.add("insert into procedimento (descricao,codigo,ch,co,porteMedico,porteAnestesico,qtdFilme,qtdAuxilio,tipo,tabela,percPorte) values ('Exame CBHPM',30409020,0.0,1.5,'1A',0,0,1.5,'sadt','cbhpm5',1.0);");
